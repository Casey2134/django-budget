...
class BudgetEstimate(StandardMetadata):
    ...
    and "Car Payment".
    """
    budget = models.ForeignKey(Budget, related_name='estimates',on_delete=models.CASCADE, verbose_name=_('Budget'))
    category = models.ForeignKey(Category, related_name='estimates',on_delete=models.CASCADE, verbose_name=_('Category'))
